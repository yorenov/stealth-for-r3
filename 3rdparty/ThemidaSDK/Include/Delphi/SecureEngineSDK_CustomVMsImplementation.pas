...
{$IFDEF WIN64}
  ...
  procedure VM_LION_WHITE_START; external SecureEngine name 'CustomVM00000161_Start';
  procedure VM_LION_WHITE_END; external SecureEngine name 'CustomVM00000161_End';
  procedure VM_LION_RED_START; external SecureEngine name 'CustomVM00000163_Start';
  procedure VM_LION_RED_END; external SecureEngine name 'CustomVM00000163_End';
  procedure VM_LION_BLACK_START; external SecureEngine name 'CustomVM00000165_Start';
  procedure VM_LION_BLACK_END; external SecureEngine name 'CustomVM00000165_End';
...
{$ELSE}
  ...
  procedure VM_LION_WHITE_START; external SecureEngine name 'CustomVM00000160_Start';
  procedure VM_LION_WHITE_END; external SecureEngine name 'CustomVM00000160_End';
  procedure VM_LION_RED_START; external SecureEngine name 'CustomVM00000162_Start';
  procedure VM_LION_RED_END; external SecureEngine name 'CustomVM00000162_End';
  procedure VM_LION_BLACK_START; external SecureEngine name 'CustomVM00000164_Start';
  procedure VM_LION_BLACK_END; external SecureEngine name 'CustomVM00000164_End';
  procedure VM_MUTATE_ONLY_START; external SecureEngine name 'Mutate_Start';
  procedure VM_MUTATE_ONLY_END; external SecureEngine name 'Mutate_End';
{$ENDIF}
