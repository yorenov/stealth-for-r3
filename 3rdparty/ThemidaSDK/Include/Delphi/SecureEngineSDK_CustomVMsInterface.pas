...
procedure VM_LION_WHITE_START(); stdcall;
procedure VM_LION_WHITE_END(); stdcall;
procedure VM_LION_RED_START(); stdcall;
procedure VM_LION_RED_END(); stdcall;
procedure VM_LION_BLACK_START(); stdcall;
procedure VM_LION_BLACK_END(); stdcall;
