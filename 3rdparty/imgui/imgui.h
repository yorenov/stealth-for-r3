...
// - Newcomers, read 'Programmer guide' in imgui.cpp for notes on how to install Dear ImGui in your codebase.
...
struct ImColor
{
    ...
    // FIXME-OBSOLETE: May need to obsolete/remove those helpers.
...
// ImDrawCallback: Draw m_callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw m_callbacks just to create your own widget or customized UI rendering,
...
// This is useful for example if you submitted m_callbacks which you know have altered the render state and you want it to be restored.
...
// It is the user-code responsibility to install/build the atlas, then upload the pixel data into a texture accessible by your graphics api.
...
struct ImFontAtlas
{
    ...
    // [Internal]
    // NB: Access texture data via GetTexData*() calls! Which will install a default font for you.
