...
//  2018-06-08: DirectX9: Use draw_data->DisplayPos and draw_data->DisplaySize to install projection matrix and clipping rectangle.
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    // install render state: fixed-pipeline, alpha-blending, no face culling, no depth testing, shade mode (for gradient), bilinear sampling.
    ...
    // install orthographic projection matrix
...
bool ImGui_ImplDX9_Init(IDirect3DDevice9* device)
{
    ...
    // install backend capabilities flags
